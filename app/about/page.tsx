...
// Team Member Card with Gradient Hover and Next/Image
...
// Timeline Component (no changes needed here)
...
const AboutUsPage = () => {
  const team = dataTeam;
  const timelineData = dataTimeline;
    ...
    <div className="bg-gray-50 text-gray-800">
      ...
      <Section className="bg-white">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <div>
              <div className="flex items-center space-x-4 mb-3"><Target className="text-blue-600" size={32} /><h2 className="text-3xl font-bold text-gray-900">Our Mission</h2></div>
            ...
            <div>
              <div className="flex items-center space-x-4 mb-3"><Eye className="text-blue-600" size={32} /><h2 className="text-3xl font-bold text-gray-900">Our Vision</h2></div>
      ...
      <Section className="bg-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg"><Globe className="mx-auto text-green-500 mb-4" size={48} /><p className="text-5xl font-bold text-blue-600"><AnimatedCounter to={40} />+</p><p className="text-xl text-gray-700 mt-2">Destinations Explored</p></div>
            <div className="bg-white p-8 rounded-lg shadow-lg"><Star className="mx-auto text-yellow-500 mb-4" size={48} /><p className="text-5xl font-bold text-blue-600"><AnimatedCounter to={2000} />+</p><p className="text-xl text-gray-700 mt-2">5-Star Reviews</p></div>
        </div>
      </Section>
      ...
      <Section>
        ...
        <div ref={timelineRef} className="relative w-full max-w-4xl mx-auto">
          <motion.div className="absolute left-1/2 top-0 bottom-0 w-1 bg-blue-200 origin-top" style={{ scaleY: timelineScroll }} />
