...
export const destinationsDataI: Destination[] = [
  {
    "name": "Thailand",
    "slug": "Thailand",
...
export const getDestinationsInternational = () => {
  return destinationsDataI;
};

// Function to fetch a single destination by its slug
export const getDestinationBySlug = (slug: string) => {
  return destinationsDataI.find((dest) => dest.slug === slug);
};
